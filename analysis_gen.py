...
_SKILL_ALIASES = {
    ...
    # NOTE: "Data Warehouse"(4) / "Data Warehousing"(3) — KEEP SPLIT per 2026-07-04 standing
    # curated decision (noun=tech artifact vs gerund=practice; see LEARNINGS.md). The 2026-07-05
    # parallel meta-run incorrectly added a fold here; reverted by today's Opus audit (skip-if-unsure).
