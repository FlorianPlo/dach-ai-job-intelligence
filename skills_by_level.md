...
| CI/CD | 2 | 14% |
| Git | 2 | 14% |
| Team Leadership | 2 | 14% |
| pandas | 2 | 14% |

## 3. Skills by role × seniority

- **AI Engineer — Intern** (n=13): Python (9), RAG (3), LLMs (3), ChatGPT (2), Claude (2), AI (2), Gemini (1), Process Optimization (1)

- **AI Engineer — Junior** (n=8): Python (6), SQL (3), LLMs (3), Java (2), RAG (2), Generative AI (2), Machine Learning (2), n8n (1)

- **AI Engineer — Mid** (n=19): Python (14), LLMs (7), RAG (6), Machine Learning (5), Azure (5), Azure OpenAI (3), Hugging Face (3), Vector Databases (3)

- **AI Engineer — Senior** (n=8): Python (8), LLMs (6), RAG (6), CI/CD (3), LLM Evaluation (2), PyTorch (2), Hugging Face (2), LangChain (2)

- **AI Engineer — Lead/Principal** (n=3): RAG (2), Python (2), Machine Learning (1), LLM Systems (1), Software Architecture (1), AI Development (1), LangChain (1), LlamaIndex (1)

- **AI Researcher — Intern** (n=3): Medical Background (1), Basic Computer Science (1), English (1), Machine Learning (1), AI (1)
...
- **Data Engineer — Intern** (n=4): Python (4), Medical Imaging (1), Data Annotation (1), R (1), Power BI (1), VBA (1), Bash (1), CI/CD (1)
...
Skills more requested at Senior/Lead level (n=77) than at lower levels (n=151), ranked by gap:
